...
// print '<p>Oh haii world from storeComment.php where JPATH_SITE = "' . JPATH_SITE . '"</p>' . "\n";

require_once "JoomoocommentStoreInDb.php";

$storeComment = new JoomoocommentStoreInDb();
$storeComment->storeInDatabase();
